...
def drone():
    ...
    # =========================================================================================
    redis_server.mset({"ID" + droneID: droneID, "Longitude" + droneID: drone_longitude, "Latitude" + droneID: drone_latitude, "DroneIP" + droneID: droneIP, "Status" + droneID: drone_status})
