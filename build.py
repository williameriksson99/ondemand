...
def get_drones():
    ...
    drone_dict = {
        '12':{'longitude': drone1_logitude_svg, 'latitude': drone1_latitude_svg, 'status': drone1_status},
        '13': {'longitude': drone2_logitude_svg, 'latitude': drone2_latitude_svg, 'status': drone2_status}
        }
